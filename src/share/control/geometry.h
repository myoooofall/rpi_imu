...
class CVector {
  public:
    ...
    CVector( CVector& v) :	_x(v.x()), _y(v.y()) {}
...
class CVector3 {
  public:
    ...
    void formXYZ(const CGeoPoint& pos2, double z = 0) {
        _x = pos2.x();
        _y = pos2.y();
        _z = z;
...
class CGeoLine {
  public:
    ...
    CGeoPoint Intersection(const CGeoLine& line) const {
        double a = line.a();
        double b = line.b();
        double c = line.c();
        if(fabs(atan2(b, a) - atan2(_b, _a))<1e-7) return CGeoPoint(-9999, -9999);
        Eigen::Matrix2d temp;
        temp << a, b,
                _a, _b;
        Eigen::Vector2d result;
        result << -c, -_c;
        result = temp.inverse() * result;
        return CGeoPoint(result[0], result[1]);
    }
...
class CGeoLineCircleIntersection {
  public:
    CGeoLineCircleIntersection():_intersectant(false), _point1(CGeoPoint(9999,9999)), _point2(CGeoPoint(9999,9999)){};
...
class CGeoSegmentCircleIntersection {
  public:
    CGeoSegmentCircleIntersection():_intersectant(false),intersection_size(0),_point1(CGeoPoint(9999,9999)),_point2(CGeoPoint(9999,9999)){}
